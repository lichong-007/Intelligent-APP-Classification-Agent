...
Standardized structured output from APK dynamic analysis, including package name, version, certificates, and country-level attribution for downstream multi-modal classification.
